                                        ...
                                        <ul class="navbar-nav w-100 d-lg-flex justify-content-center">
                                            ...
                                            <li class="nav-item drop-menu"><a class="nav-link text-capitalize"
                                                ...
                                                <div class="sub_menu">
                                                    ...
                                                    <div class="col">
                                                        <a class="hosting-tab6" href="window-hosting.php">
                                                            <img src="images/hosting-icon/data-center.png">
                                                            <h5>Window Hosting</h5>
                                                        </a>
                                                    </div>
                                                    <div class="col">
                                                        <a class="hosting-tab7" href="rdp-servers.php">
                                                            <img src="images/hosting-icon/data-center.png">
                                                            <h5>RDP Hosting</h5>
                                                        </a>
                                                    </div>
                                            ...
                                            <li class="nav-item drop-menu"><a class="nav-link text-capitalize"
                                                ...
                                                <div class="sub_menu">
                                                    <div class="col">
                                                        <a class="development-tab1" href="web-development.php">
                                                            <img src="images/hosting-icon/data-center.png">
                                                            <h5>Web Development</h5>
                                                        </a>
                                                    </div>
                                                    <div class="col">
                                                        <a class="development-tab2" href="ecommerce-development.php">
                                                            <img src="images/hosting-icon/data-center.png">
                                                            <h5>E-commerce Development</h5>
                                                        </a>
                                                    </div>
                                                    <div class="col">
                                                        <a class="development-tab3" href="wordpress-development.php">
                                                            <img src="images/hosting-icon/data-center.png">
                                                            <h5>WordPress Development</h5>
                                                        </a>
                                                    </div>
                                                    <div class="col">
                                                        <a class="development-tab4" href="mobile-development.php">
                                                            <img src="images/hosting-icon/data-center.png">
                                                            <h5>Mobile Development</h5>
                                                        </a>
                                                    </div>
                                                    <div class="col">
                                                        <a class="development-tab5" href="woocommerce-development.php">
                                                            <img src="images/hosting-icon/data-center.png">
                                                            <h5>WooCommerce Development</h5>
                                                        </a>
                                                    </div>
                                                    <div class="col">
                                                        <a class="development-tab6" href="custom-development.php">
                                                            <img src="images/hosting-icon/data-center.png">
                                                            <h5>Custom Development</h5>
                                                        </a>
                                                    </div>
                                                    <div class="col">
                                                        <a class="development-tab7" href="application-development.php">
                                                            <img src="images/hosting-icon/data-center.png">
                                                            <h5>Application Development</h5>
                                                        </a>
                                                    </div>
                                                    <div class="col">
                                                        <a class="development-tab8" href="plugin-development.php">
                                                            <img src="images/hosting-icon/data-center.png">
